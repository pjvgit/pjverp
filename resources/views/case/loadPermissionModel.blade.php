        ...
        <div class="col-md-6">
            ...
            <div class=" mb-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <label class="radio radio-outline-success">
                            <input type="radio" name="edit_permisssion" <?php if(!$ContractUserPermission->isEmpty() && $ContractUserPermission[0]->edit_permisssion == "0" ) { ?> checked="checked" <?php } ?> value="0"><span> Yes</span><span
                                class="checkmark"></span>
                        </label>
                    </div>
                    <div class="col-sm-3">
                        <label class="radio radio-outline-success">
                            <input type="radio" name="edit_permisssion" <?php if(!$ContractUserPermission->isEmpty() && $ContractUserPermission[0]->edit_permisssion == "1" ) { ?> checked="checked" <?php } ?>  value="1" checked="checked"><span>No</span><span
                                class="checkmark"></span>
                        </label>
                    </div>
                </div>
