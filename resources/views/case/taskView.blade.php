    ...
    <div class="col-6">
        ...
        <table class="table table-bordered mt-3" id="taskReviewArea">
            <tbody>
                ...
                <tr class="border-top-0 task-checklist-background-incomplete <?php echo ($TaskData->status=="0") ?  "table-info"  : 'table-success'; ?>">
                    <td class="text-center border-top-0 border-right-0 task-checkbox-column float-left">
                    <?php $findComletedPErcent = (!$TaskChecklist->isEmpty()) ? ($TaskChecklistCompleted / count($TaskChecklist) * 100) : 0;?>
