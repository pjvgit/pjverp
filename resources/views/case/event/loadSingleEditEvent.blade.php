...
<div class="modal-body">
    <div class="row" bladefilename="resources/views/case/event/loadSingleEditEvent.blade.php">
        <div class="col-md-12" >
                ...
                <div class="row">
                    ...
                    <?php } ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2 form-group mb-3">
                                {{-- <input class="form-control input-date input-end" id="end_date" value="{{date('m/d/Y',strtotime($convertedEndDateTime))}}" name="end_date" type="text" placeholder="mm/dd/yyyy"> --}}
                                <input class="form-control input-date input-end" id="end_date" value="{{date('m/d/Y',strtotime($evetData->user_end_date))}}" name="end_date" type="text" placeholder="mm/dd/yyyy">
                    ...
                    <div class="col-4">
                        ...
                        if(Auth::User()->add_event_guide2=="0"){?>
                            <div class="client-task-tip m-3" id="add_event_guide2">
    ...
    $(document).ready(function () {
        ...
        $("input:checkbox.no_case_link").click(function () {
            if ($(this).is(":checked")) {
                ...
                $('#case_or_lead').prop('selectedIndex',"");
                // firmStaff();
            } else {
