<form class="deleteEventFromCommentFromComment" id="deleteEventFromComment" name="deleteEventFromComment" method="POST">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#deleteEventFromComment').submit(function (e) {
