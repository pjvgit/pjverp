<form class="AddNote" id="AddNote" name="AddNote" method="POST">
    ...
    @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input class="form-control field datepicker" value="{{ convertUTCToUserTimeZone('dateOnly') }}" id="dateadded" maxlength="250" name="note_date"
                    type="text">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="justify-content-between modal-footer">
            ...
            <div>
                ...
                <button class="btn btn-outline-secondary btn-rounded  m-1" onclick="setButton('st')" id="saveandtime" value="saveandtime"
                    type="submit">Save + <i class="far fa-clock fa-lg"></i></button>


                <button class="btn btn-primary  btn-rounded m-1 submit" id="submitButton" onclick="setButton('s')"  value="savenote" type="submit">Save</button>
            </div>
        </div>
    </div>
...
<style>
    body>#editor {margin: 50px auto;max-width: 720px;}
    #editor {height: 300px;background-color: white;}
</style>
