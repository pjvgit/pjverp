<form class="EmailFormFromCase" id="EmailFormFromCase" name="EmailFormFromCase" method="POST">
    ...
    <div class="col-md-12">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input class="form-control" value="{{$caseIntakeForm['submited_to']}}" id="email_address" maxlength="250" name="email_address" type="text"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#EmailFormFromCase').submit(function (e) {
            $(".submit").attr("disabled", true);
            $(".innerLoader").css('display', 'block');
            e.preventDefault();

            if (!$('#EmailFormFromCase').valid()) {
                $(".innerLoader").css('display', 'none');
                $('.submit').removeAttr("disabled");
                return false;
            }
            var dataString = '';
            dataString = $("#EmailFormFromCase").serialize();
            $.ajax({
                type: "POST",
                url: baseUrl + "/court_cases/sendEmailIntakeFormCase", // json datasource
                data: dataString,
