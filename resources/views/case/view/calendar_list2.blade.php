                                    ...
                                    <tr>
                                        ...
                                        <td class="event-users">
                                            ...
                                            <div class="mt-3 float-right">
                                                ...
                                                @php
                                                    $commentCount = 0;
                                                    if(count($item->eventLinkedStaff)) {
                                                        $lastReadAt = $item->eventLinkedStaff()->wherePivot('user_id', auth()->id())->first();
                                                        if($lastReadAt)
                                                            $commentCount = $item->eventComments->where("created_at", ">=", $lastReadAt->pivot->comment_read_at)->count();
                                                    }
                                                @endphp
                                                ...
                                                <?php }else{?>
                                                    <a class="align-items-center" data-toggle="modal" data-target="#loadEditEventPopup"
                                                    data-placement="bottom" href="javascript:;"
                                                    onclick="editEventFunction({{$item->id}}, {{$item->id}});">
                                                    <i class="fas fa-pen pr-2  align-middle"></i> </a>
                                                <?php } ?>
                                                @endcan
