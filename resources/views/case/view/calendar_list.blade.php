                    ...
                    @else
                        ...
                        @forelse ($allEvents as $key => $item)
                            ...
                            @forelse($period as $date)
                                @php
                                    $item = $allEvents->where('edit_recurring_pattern', 'single event')->where('start_date', '=', date('Y-m-d', strtotime($date)));
                                @endphp
                                <tr>
                                    ...
                                    <td>
                                        <div class="ml-2 mt-3">
                                        @php
                                        if($item->start_date==NULL || $item->end_time==NULL && $item->is_all_day == "yes"){
                                            echo "All Day";
                                        }else{                        
                                            echo date('h:i A',strtotime($item->start_date_time));
                                            echo "-";
                                            echo date('h:i A',strtotime($item->end_date_time));
                                        }
                                        @endphp
                                        </div>
                                    </td>
