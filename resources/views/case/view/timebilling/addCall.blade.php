        ...
        <form class="AddIncomingCall" id="AddIncomingCall" name="AddIncomingCall" method="POST">
            ...
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control input-date" value="{{ convertUTCToUserTimeZone('dateOnly') }}" id="dateadded" maxlength="250"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#AddOutgoingCall").validate({
            ...
            errorPlacement: function (error, element) {
                if (element.is('#caller_name_out')) {
                    error.appendTo('#callernameout');
                }else if (element.is('#call_for_out')) {
                    error.appendTo('#callfornameout');
                }else {
                    element.after(error);
                }
            }
