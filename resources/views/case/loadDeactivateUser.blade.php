...
?>
<form class="saveDeactivate" id="saveDeactivate" name="saveDeactivate" method="POST">
    @csrf
    <div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#saveDeactivate').submit(function (e) {
            $("#innerLoader").css('display', 'block');
            e.preventDefault();

            if (!$('#saveDeactivate').valid()) {
                $("#innerLoader").css('display', 'none');
                return false;
            }
            ...
            $.ajax({
                type: "POST",
                url: baseUrl + "/contacts/saveDeactivate", // json datasource
                data: dataString,
