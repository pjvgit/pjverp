    ...
    <form class="saveHistoryForm" id="saveHistoryForm" name="saveHistoryForm" method="POST">
        ...
        <div class="row fieldGroup">
            ...
            <div class="col-3">
                <input type="text" id="start_date_{{$key+1}}"   name="start_date[{{$key}}]" class="form-control dp"  value="{{date('m/d/Y',strtotime($stage['start_date'] ?? convertUTCToUserTimeZone('dateOnly')))}}" onchange="getEndDate({{$key+1}})"></p>
            </div>
            <div class="col-3">
        ...
        <div class="row ">
            ...
            <?php 
                ...
                $end = strtotime(convertUTCToUserTimeZone('dateOnly'));
