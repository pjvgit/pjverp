<div class="d-flex flex-row w-100 mt-3">
    <div>
        ...
        <?php } ?>
        <a href="/time_entries/timesheet_calendar">View another Firm User's Calendar</a>
    </div>
    <?php 
        if(in_array($type,["all","b"])){?>
        ...
        <div>
            <div class="d-flex">
                ...
                if(Auth::User()->set_goal!="0.00"){
                    ?><strong>{{number_format(Auth::User()->set_goal)}}hrs/
                    {{$fArray[Auth::User()->goal_frequency]}}</strong><?php 
                }else{
                                ...
                                <div class="col-4 pl-0">
                                    <div>
                                        <div class=""><select id="duration-field" name="duration_field"
                                                class="form-control custom-select  ">
                                                <option
                                                    <?php if(Auth::User()->goal_frequency=="daily") { echo "Selected=selected"; } ?>
                                                    value="daily">Day</option>
                                                <option
                                                    <?php if(Auth::User()->goal_frequency=="weekly") { echo "Selected=selected"; } ?>
                                                    value="weekly">Week</option>
                                                <option
                                                    <?php if(Auth::User()->goal_frequency=="monthly") { echo "Selected=selected"; } ?>
                                                    value="monthly">Month</option>
                                            </select></div>
                                    </div>
                                </div>
                                <div class="col-2 pl-0 mt-2"><i class="fas fa-trash align-middle p-2"
                                        onclick="deleteGoalEntry();"></i></div>
                            </div>
                        </div>
