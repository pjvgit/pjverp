    ...
    <div class="tab-pane fade  active show" id="tba2" role="tabpanel" aria-labelledby="profile-basic-tab">
        <form class="addWithdrawForm" id="addWithdrawForm" name="addWithdrawForm" method="POST">
            ...
            <div class="row form-group">
                <label for="notes" class="text-sm-right pr-0 col-sm-3 col-form-label">Credit Account</label>
                    ...
                    <div>
                        <div class="">
                            <div class="input-group">
                                ...
                                <input class="form-control number" style="width:50%; " maxlength="20" name="amount" id="amount" value="" type="text" aria-label="Amount (to the nearest dollar)">
                                <small>&nbsp;</small>
...
<script type="text/javascript">
    ...
    $('#addWithdrawForm').submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: baseUrl + "/contacts/clients/saveWithdrawFromCredit", // json datasource
            data: dataString ,
