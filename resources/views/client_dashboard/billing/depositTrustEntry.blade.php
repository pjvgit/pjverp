...
?>
<div class="row">
    <div class="col-md-6">Contact: {{$userData->cname}} (Client)</div>
</div>
<div class="row">
    <div class="col-md-12" data-testid="deposit-into-account-balance"><strong>Current Balance:
            ${{number_format($UsersAdditionalInfo->trust_account_balance,2)}}</strong></div>
</div>
<br>
...
<script type="text/javascript">
    ...
    function didPayment() {
        ...
        swal({
            ...
            $.ajax({
                type: "POST",
                url: baseUrl + "/contacts/clients/saveTrustEntry", // json datasource
                data: dataString,
