        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="padding:5px;">
                    ...
                    convertDateToUserTimeOffset((($firstCreditBalance->payment_datetime) ? $firstCreditBalance->payment_datetime : $firstCreditBalance->payment_date), $authUser->user_timezone)->format('m/d/Y')
                    }}
                </td>
