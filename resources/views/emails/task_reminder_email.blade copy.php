...
<p style="color: #000;    font-family: sans-serif;font-size: 15px;font-weight: 500;padding-bottom: 10px;">For additional details about this task, please sign in to your LegalCase account.
</p>
<a href="{{ route("tasks", ['id' => $task->id]) }}" style="background-color: #036fb7;padding: 12px;border-radius: 5px;color: #fff;">View Task</a>
<br>
<br>
