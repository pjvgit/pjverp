<div class="modal-header">
    <div class="header-left-group">
        ...
        <h6 class="modal-subtitle mt-2 mb-0">{{date('D, M jS Y',strtotime($evetData->start_date))}}
            ,{{date('h:ia',strtotime($evetData->start_time))}} —
            {{date('D, M jS Y',strtotime($evetData->end_date))}}, {{date('h:ia',strtotime($evetData->end_time))}}</h6>
    </div>
