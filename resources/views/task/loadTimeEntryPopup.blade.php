        ...
        <form class="savenewTimeEntry" id="savenewTimeEntry" name="savenewTimeEntry" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-10 form-group mb-3"> 
                    <select class="form-control case_or_lead dropdown" id="case_or_lead" name="case_or_lead"
                        data-placeholder="Search for an existing contact or company">
                        <option value="">Select case</option>
                        <?php foreach($CaseMasterData as $casekey=>$Caseval){ ?>
                        <option <?php if($TaskData->case_id==$Caseval->id){ echo "selected=selected"; }?>
            ...
            <div class="form-group row">
                ...
                <div class="col-10 form-group mb-3">
                    <select class="form-control staff_user dropdown" id="staff_user" name="staff_user">
                        <?php foreach($loadFirmStaff as $loadFirmStaffkey=>$CasevloadFirmStaffvalal){ ?>
                        <option <?php if($CasevloadFirmStaffvalal->id==$selectedId){ echo "selected=selected"; }?> value="{{$CasevloadFirmStaffvalal->id}}">{{$CasevloadFirmStaffvalal->first_name}}
            ...
            <div>
                <button type="button" class="btn btn-link p-0 border-0 form-group">Custom Fields <i
                        class="fas fa-sort-up align-bottom"></i></button>
                <div class="form-group row"><label for="custom_fields_empty_state"
                    ...
                    <div class="col">
                        <div>Have more information you want to add? You can create custom fields for
                            time entry by going to "Settings"
        ...
        <form class="savebulkTimeEntry" id="savebulkTimeEntry" name="savebulkTimeEntry" method="POST">
            ...
            <div class="bulk-time-entries-row-0 fieldGroup">
                <div class="no-gutters row ">
                    <div class="pr-4 col-4">
                        <div class="">
                            <div class="row no-gutters">
                                <select  class="form-control case_or_lead" dvid="1" id="hideoptioninput21" name="case_or_lead[1]"
                                    data-placeholder="Search for an existing contact or company">
                                    <option value="">Select case</option>
                                    <?php foreach($CaseMasterData as $casekey=>$Caseval){ ?>
                    ...
                    <div class="pr-2 col-3">
                        <input id="bulk-time-entry-row-description-0" name="description[1]"  class="form-control description-field"
                            value="John called about the upcoming meeting, please call him back.">
                    </div>
                    <div class="col-1">
                        <div class="">
                            <input id="hideoptioninput2duration1" type="number" steps="0.1" name="duration[1]" class="form-control duration-field"
                                value="">
                        </div>
                    </div>
                        ...
                        <div class="">
                            <div class="form-check">
                                <label class="form-check-label ">
                                    <input type="checkbox" name="billable[1]" class="billable-field form-check-input" checked="checked">
            ...
            <div class="maturity_div copy-new hide maturity_div" id="optionTemplate2">
                <div class="no-gutters row ">
                    ...
                    <div class="pr-2 col-3">
                        <input id="bulk-time-entry-row-description-0"  name="description[]" class="form-control description-field"
                            value="John called about the upcoming meeting, please call him back.">
                    </div>
                    <div class="col-1">
                        <div class="">
                ...
                <div class="mb-2 row ">
                    <div class="col-7">
                        <div class="">
                            <div class="form-check">
                                <label class="form-check-label ">
                                    <input type="checkbox" name="billable[]" class="billable-field form-check-input" checked="">
    ...
    $(".dropdown_activity").select2({
        ...
        $(".add-more-five").click(function () {
            ...
            for (var i = 1; i <= 5; i++) {
                ...
                //For option 3
                $('#billableid' + (parseInt(hideinputcount2) + parseInt(1))).attr('name', 'billable[' + (parseInt(hideinputcount2) + parseInt(1)) + ']');

                //For description
                $('#descriptionid' + (parseInt(hideinputcount2) + parseInt(1))).attr('name', 'description[' + (parseInt(hideinputcount2) + parseInt(1)) + ']');
                $('#hideinputcount2').val((parseInt(hideinputcount2) + parseInt(1)));
