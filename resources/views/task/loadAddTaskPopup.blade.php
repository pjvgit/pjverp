           ...
           <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-8 form-group mb-3">
                    <select onChange="changeCaseUser111()" class="form-control case_or_lead_cc" id="case_or_lead" name="case_or_lead"
                        ...
                        <optgroup label="Court Cases">
                            ...
                            <option uType="case" <?php if(isset($case_id) && $case_id!="" && $Caseval->id==$case_id){ echo "selected=selected"; } ?>
...
<script type="text/javascript">
    $(document).ready(function () {
       ...
       //$(".datepicker" ).datepicker();
        ...
        $(".case_or_lead_cc").select2({
            placeholder: "Select...",
            theme: "classic",
            allowClear: true,
            dropdownParent: $("#loadAddTaskPopup"),
        });
        ...
        $('#CreateTask').submit(function (e) {
           ...
           $(this).find(":submit").prop("disabled", true);
            ...
            $.ajax({
                type: "POST",
                url: baseUrl + "/tasks/saveAddTaskPopup", // json datasource
                data: dataString,
