            ...
            <div id="firstStep">
                ...
                <div class="justify-content-between modal-footer">
                    ...
                    <div>
                        ...
                        <button class="btn btn-primary example-button m-1 submit" id="submit" type="submit" data-style="expand-left">Save Event </button>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("input:checkbox#no_case_link").click(function () {
            if ($(this).is(":checked")) {
                ...
                $('.caseleadSingleEvent').prop('selectedIndex',0);
    ...
    function changeCaseUserEdits() {
        ...
        var selectdValue = $(".caseleadSingleEvent option:selected").val();
        if(selectdValue!=''){
            if(uType=="case"){
