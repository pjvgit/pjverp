        ...
        <?php } ?>
            ...
            <span id="dateInputPanel">
                <div class="form-group row">
                    ...
                    <div class="col-md-2 form-group mb-3">
                        <input class="form-control input-date input-start" id="start_date" value="{{date('m/d/Y')}}" name="start_date" type="text"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2 form-group mb-3 ">
                        <input class="form-control input-date input-end" id="end_date" value="{{date('m/d/Y')}}" name="end_date" type="text"
                            placeholder="mm/dd/yyyy">
            ...
            if(Auth::User()->add_task_guide=="0"){?>
                <div class="client-task-tip" id="guiderArea">
                    <div class="alert alert-info">
                        ...
                        <div class="tooltip-message">When you add clients and contacts to an event, they will receive an email with a link to view it in their portal.<a href="#" rel="noopener noreferrer"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#createEvent").validate({
            ...
            errorPlacement: function (error, element) {
                if (element.is('#case_or_lead_popup')) {
        ...
        $("input:checkbox.no_case_link").click(function () {
            if ($(this).is(":checked")) {
                $("#case_or_lead_popup").attr("disabled", true);
                $('#case_or_lead_popup').prop('selectedIndex',0);
                
                changeCaseUser();
                $(".hideUser").hide();
            } else {
                $(".hideUser").show();
                $('#case_or_lead_popup').removeAttr("disabled");
            }
        });
        ...
        $("input:checkbox.recuring_event").click(function () {
            if ($(this).is(":checked")) {
                ...
                $("#endondiv").show();
                $("input:checkbox#no_end_date_checkbox").prop("checked", true);
    ...
    //     var selectdValue = $("#case_or_lead_popup option:selected").val() // or
    ...
    function changeCaseUser() {
        $("#text_lead_id").val('');
        $("#text_case_id").val('');
        var uType=$("#case_or_lead_popup option:selected").attr('uType');
        var selectdValue = $("#case_or_lead_popup option:selected").val() 
        if(selectdValue!=''){
            if(uType=="case"){
