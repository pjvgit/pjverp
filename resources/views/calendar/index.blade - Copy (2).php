        ...
        $('#datepicker').datepicker({
            ...
            $('#calendarq').fullCalendar({
                ...
                header: {
                    ...
                    center: 'title',
                    right: 'staffView,month,agendaWeek,agendaDay,agendaFourDay'
                },
                        ...
                        success: function (doc) {
                            ...
                            if (!!doc.mytask) {
                                $.map(doc.mytask, function (r) {
                                    var t = '<span class="calendar-badge d-inline-block undefined badge badge-secondary" style="background-color: rgb(254, 193, 8); width: 30px;">DUE</span>'+' ' + r.task_title
            ...
            CustomViewStaff = View1.extend({ // make a subclass of View
                ...
                render: function() {
                    ...
                    $.ajax({
                            ...
                            success: function (doc) {
                                $('.fc-view').append('DA123123123123123A');
                            }
                        });
                },
                setHeight: function(height, isAuto) {
