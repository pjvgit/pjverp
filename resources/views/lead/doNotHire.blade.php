...
<form class="EditFormData" id="EditFormData" name="EditFormData" method="POST">
    ...
    <div class="col-md-12">
        <div class="form-group row" id="show_contact_group_dropdown">
            ...
            <div class="col-sm-6">
                <select class="form-control contact_group not_hire_reasons_id" id="not_hire_reasons_id" name="not_hire_reasons_id"
            ...
            <label for="inputEmail3" class="col-sm-3 col-form-label"> 
                <a onclick="openNewContactGroup();" href="javascript:;">Add New No Hire Reason</a>
            </label>
        </div>
