    ...
    <div class="col">
        ...
        <div class="d-flex py-1">
            <label for="time-estimate-20186218" class="col-sm-3 col-form-label">{{$val->first_name}}
                {{$val->last_name}}</label>
            <input id="time-estimate-20186218" name="time_estimate_for_staff[{{$val->id}}]" min="0" type="number"
                class="col-sm-2 form-control onlyNumber price" value="{{($fillsedHours[$val->id])??0}}">
