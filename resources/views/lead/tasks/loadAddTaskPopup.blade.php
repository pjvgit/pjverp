                ...
                <div class="col-8 form-group mb-3">
                    <select onChange="changeCaseUser111()" class="form-control case_or_lead" id="case_or_lead" name="case_or_lead"
                        ...
                        <optgroup label="Court Cases">
                            ...
                            <option uType="case" <?php if(isset($case_id) && $case_id==$Caseval->id){ echo "selected=selected"; } ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".case_or_lead").select2({
            ...
            theme: "classic",
            allowClear: true,
            dropdownParent: $("#loadAddSingleTaskAddPopup"),  //#addTaskFromLog
        });
        $( "#sortable" ).sortable();
    ...
    function loadTimeEstimationUsersListMain() {
        console.log("resources/views/lead/tasks/loadAddTaskPopup.blade.php > loadTimeEstimationUsersListMain > 615");
        var array = [];
