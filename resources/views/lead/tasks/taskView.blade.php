    ...
    <div class="border-bottom border-2 bg-light-c px-4 py-3">
        ...
        <div>
            ...
            if(isset($CaseMasterData) && !empty($CaseMasterData)){?>
                <strong>Case:</strong>
                <a class="ml-2"
                    href="{{BASE_URL}}court_cases/{{$CaseMasterData->case_unique_number}}/info">{{$CaseMasterData->case_title}}
                </a>
            <?php } ?>
        </div>
    </div>
                        ...
                        <div class="ml-auto">
                            <div class="actions-cell float-right">
                                <div class="d-flex align-item-center task-action-buttons-16497173">
                                    ...
                                    <div> <a class="align-items-center" data-toggle="modal" data-target="#editTask"
                                        data-placement="bottom" href="javascript:;"
                                        onclick="editTask({{$TaskData->id}},'yes');">
