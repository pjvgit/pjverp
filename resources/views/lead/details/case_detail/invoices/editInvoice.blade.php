...
<form class="Editnvoice m-3" id="Editnvoice" name="Editnvoice" method="POST">
    ...
    <div class="row" bladefile="resources/views/lead/details/case_detail/invoices/editInvoice.blade.php">
        ...
        <div class="col-md-6 form-group mb-3">
            ...
            <input class="form-control datepicker" value="{{date('m/d/Y',strtotime($FindInvoice->created_date_new))}}" id="invoiceDate" maxlength="250"
        ...
        <div class="col-md-6 form-group mb-3">
            ...
            <input class="form-control datepicker" value="{{date('m/d/Y',strtotime($FindInvoice->due_date_new))}}" id="dueDate" maxlength="250"
