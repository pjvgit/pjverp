...
<form class="EditFormData" id="EditFormData" name="EditFormData" method="POST">
    <input class="form-control" id="id" value="{{ $ReferalResource->id}}" name="id" type="hidden">
    ...
    <div class="col-md-12">
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input class="form-control" value="{{ $ReferalResource->title}}" id="lead_referral_source" maxlength="250" name="lead_referral_source" type="text"
...
<script type="text/javascript">
    ...
    $('#EditFormData').submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: baseUrl + "/lead_setting/updateReferalSource", // json datasource
            data: dataString,
