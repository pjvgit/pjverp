<form class="archiveCompanyForm" id="archiveCompanyForm" name="archiveCompanyForm" method="POST">
    ...
    <div class="col-md-12">
        <div class="form-group row">
            <label for="inputEmail3" class="col-sm-12 col-form-label"><b>Are you sure you want to archive this company?
                </b></label>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                ...
                if(!$caseCllientSelection->isEmpty()){
                    ?>
                Also archive the following company contacts:
                        ...
                        <td>
                            <div id="share_link">
                                <label id="court_case_user_link_share_label">
                                    ...
                                    Disable login for any company contacts that are checked above.
                                </label>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="form-group row float-right">
            ...
            <button class="btn btn-primary ladda-button example-button m-1 submit" id="submitButton"
                type="submit">Archive Company</button>
        </div>
...
<script type="text/javascript">
    ...
    $('#archiveCompanyForm').submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: baseUrl + "/contacts/companies/archiveCompany", // json datasource
            data: dataString,
            ...
            success: function (res) {
                if (res.errors != '') {
                    ...
                    window.location.href=baseUrl+'/contacts/companies/{{$company_id}}/clients';
                }
            },
