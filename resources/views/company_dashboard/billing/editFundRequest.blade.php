        ...
        <div class="modal-body retainer-requests-popup-content">
            <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                    ...
                    <input class="form-control input-date" value="{{date('m/d/Y',strtotime(date('Y-m-d', strtotime(convertUTCToUserDate($RequestedFund->due_date, auth()->user()->user_timezone)))))}}" id="due_date" maxlength="250" name="due_date" type="text">
                </div>
