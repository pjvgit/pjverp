<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade  active show" id="tba2" role="tabpanel" aria-labelledby="profile-basic-tab">
        <form class="refundForm" id="refundForm" name="refundForm" method="POST">
            ...
            <input type="hidden" id="transaction_id" value="{{$TrustHistory->id}}" name="transaction_id">
                    ...
                    <div>
                        <div class="">
                            <div class="input-group">
                                ...
                                <?php
                                if($TrustHistory->fund_type=="withdraw"){
                                    $mt=$TrustHistory->withdraw_amount;
                                }else{
                                    $mt=$TrustHistory->amount_paid;
                                } 
                                ?>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-sm-9">
                    <div>
                        <div class="">
                            <div class="input-group">
                                <input class="form-control input-date" value="{{date('m/d/Y')}}" id="payment_date"
...
<script type="text/javascript">
    ...
    $('#refundForm').submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: baseUrl + "/contacts/clients/saveRefundPopup", // json datasource
            data: dataString,
