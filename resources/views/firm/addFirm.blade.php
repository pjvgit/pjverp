...
<form class="AddNewOfficeForm" id="AddNewOfficeForm" name="AddNewOfficeForm" method="POST">
    ...
    <div class="col-md-12">
        <div class="form-group row  pb-2">
            ...
            <div class="col-sm-8">
                <input class="form-control" value="" id="office_name" maxlength="250" name="office_name" type="text"
        ...
        <div class="form-group row pb-2">
            ...
            <div class="col-md-9 form-group mb-3">
                <div class="form-group form-check">
                    <input class="form-check-input" type="checkbox"  name="primary_office"
                        id="office_primary">
        ...
        <div class="form-group row  pb-2">
            ...
            <div class="col-md-9 form-group mb-10">
                <input class="form-control" id="cell_phone" value="" maxlength="255" name="main_phone"
        ...
        <div class="form-group row  pb-2">
            ...
            <div class="col-md-9 form-group mb-10">
                <input class="form-control" id="cell_phone" value="" maxlength="255" name="fax_line"
                    placeholder="(xxx)-xxx-xxxx">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9 form-group mb-3">
                <input class="form-control" id="postal_code" value="" maxlength="255" name="apt_unit"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-2 form-group mb-3">
                <input class="form-control" id="state" name="state" value="" maxlength="255" placeholder="State">
            </div>
    ...
    <div class="form-group row  float-right">
        <div class="col-md-12 form-group ">
            ...
            <button class="btn btn-primary ladda-button example-button mr-3 submit" id="submit" type="submit">Create
                Office</button>
        </div>
    </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#country").select2({
            ...
            theme: "classic",
            allowClear: true,
            dropdownParent: $("#addNewOffice"),
        });
        $("#AddNewOfficeForm").validate({
            rules: {
                office_name: {
                    required: true,
                    minlength: 2
    ...
    $('#AddNewOfficeForm').submit(function (e) {
        beforeLoader();
        e.preventDefault();
        if (!$('#AddNewOfficeForm').valid()) {
            afterLoader();
            return false;
        }
        var dataString = '';
        dataString = $("#AddNewOfficeForm").serialize();
        $.ajax({
            type: "POST",
            url: baseUrl + "/firms/saveNewFirm", // json datasource
            data: dataString,
