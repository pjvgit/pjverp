                    ...
                    <li class="{{ request()->is('events*') ? 'open' : '' }}">
                        <div>
                            <div>
                                ...
                                <a href="{{route('events/')}}">Calender <span class="badge badge-secondary eventCount" style="margin-bottom: 10px;">{{ (getUnreadEventCount() > 0) ? getUnreadEventCount() : '' }}</span></a><input type="checkbox" id="drop-2"><input
                    ...
                    <li class="{{ request()->is('tasks*') ? 'open' : '' }}">
                        <div>
                            <div>
                                ...
                                <a href="{{route('tasks')}}">Tasks @if(getUnreadTaskCount() > 0) <span class="badge badge-secondary {{-- taskCount --}}" style="margin-bottom: 10px;">{{ getUnreadTaskCount() }}</span> @endif</a><input type="checkbox" id="drop-2">
