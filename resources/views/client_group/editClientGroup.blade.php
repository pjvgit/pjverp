...
<form class="CreatGroup" id="CreatGroup" name="CreatGroup" method="POST">
    ...
    <div class="col-md-12">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input class="form-control" value="{{$ClientGroup->id}}" id="id" name="id" type="hidden">
                <input class="form-control" value="{{$ClientGroup->group_name}}" maxlength="255" id="group_name" name="group_name" type="text"
        ...
        <div class="form-group row float-right">
            ...
            <button class="btn btn-primary ladda-button example-button m-1" id="submit" type="submit"
                data-style="expand-left"><span class="ladda-label">Edit Client Group</span><span
...
<script type="text/javascript">
    ...
    $('#CreatGroup').submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: baseUrl + "/contacts/saveEditClientGroup", // json datasource
            data: dataString,
