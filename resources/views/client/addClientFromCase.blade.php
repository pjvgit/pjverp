<div id="showErrorInnerCase" style="display:none"></div>
<form class="createNewUser" id="createNewUser" name="createNewUser" method="POST">
    ...
    <div class="col-md-12">
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input class="form-control" value="" id="first_name" maxlength="255" name="first_name" type="text"
                    placeholder="Enter your first name">
            </div>
            <div class="col-sm-2">
                <input class="form-control" value="" id="middle_name"  maxlength="255" name="middle_name" type="text" placeholder="M">
            </div>
            <div class="col-sm-4">
                <input class="form-control" id="last_name" value=""  maxlength="255" name="last_name" type="text"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10 form-group mb-3">
                <input class="form-control" id="email" name="email" value=""  maxlength="191" type="text" placeholder="Enter Email">
            </div>
        </div>
        ...
        <div class="form-group row" id="show_contact_group_text">
            <label for=" inputEmail3" class="col-sm-2 col-form-label">Contact Group</label>
            <div class="col-md-6 form-group mb-3">
                <input class="form-control" id="contact_group_text" value=""  maxlength="255"  name="contact_group_text" type="text"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10 form-group mb-3">
                <label class="switch pr-5 switch-success mr-3"><span>Enable</span>
                    <input type="checkbox" name="client_portal_enable" id="client_portal_enable" <?php if($client_portal_access->client_portal_access=="yes"){ echo "Checked=checked";} ?>><span class="slider"></span>
                </label>
                <br>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10 form-group mb-3">
                <input class="form-control" id="address" name="address"  maxlength="255"  value="" type="text" placeholder="Enter address">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputEmail3" class="col-sm-2 col-form-label">Address2</label>
            <div class="col-md-10 form-group mb-3">
                <input class="form-control" id="address2" name="address2"  maxlength="255"  value="" type="text" placeholder="Enter address2">
            </div>
        </div>
        ...
        <div class="form-group row" id="show_company_text">
            <label for="inputEmail3" class="col-sm-2 col-form-label">Company</label>
            <div class="col-md-6 form-group mb-3">
                <input class="form-control" id="company_name_text" value=""  maxlength="255" name="company_name_text" type="text"
                    placeholder="Enter new company name">
            </div>
            <label for="inputEmail3" class="col-sm-4 col-form-label"> <a onclick="openOldCompany();"
                    href="javascript:;">Cancel</a></label>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4 form-group mb-3">
                <input class="form-control" id="driver_license"  maxlength="255" name="driver_license" value="" placeholder="Enter driver license">
            </div>
            <div class="col-md-3 form-group mb-3">
                <input class="form-control" id="driver_state" maxlength="255"  name="driver_state" value="" placeholder="Enter license state">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10 form-group mb-3">
                <textarea name="notes" class="form-control" rows="5"   maxlength="512"  placeholder="Enter notes"></textarea>
            </div>
        </div>
    </span>
    ...
    <div>
        <div class="form-group row"><label for="custom_fields_empty_state" class="col-sm-3 col-form-label"></label><div class="col"><div>Have more information you want to add? You can create custom fields for 
        contacts by going to "Settings"
        and clicking "Custom Fields".<a class="ml-2" href="https://help.mycase.com/s/article/Custom-Fields-Overview-w-VIDEO" target="_blank" rel="noopener noreferrer">Learn More</a></div></div></div>
    </div>
    </span>
    <hr>
    <div class="form-group row">
        <a class="col-sm-2" href="#">
            <button class="btn btn-secondary  m-1" type="button" data-dismiss="modal" id="close">Cancel</button>
        </a>
        <label for="inputEmail3" class="col-sm-8 col-form-label"> <div class="loader-bubble loader-bubble-primary" id="innerLoader" style="display:none;"></div></label>
        <label for="inputEmail3" class="col-sm-2 col-form-label"><button class="btn btn-primary ladda-button example-button m-1" id="submit" type="submit"
            data-style="expand-left"><span class="ladda-label">Save Contact</span><span
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res.errors != '') {
                    ...
                    errotHtml += '</ul></div>';
                    $('#showErrorInnerCase').append(errotHtml);
                    $('#showErrorInnerCase').show();
                    $("#innerLoader").css('display', 'none');
                    $('#submit').removeAttr("disabled");
                    $('#AddContactModal').animate({ scrollTop: 0 }, 'slow');
