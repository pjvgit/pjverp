<div id="showError1" class="showError" style="display:none"></div>
<form class="updateUser" id="updateUser" name="updateUser" method="POST">
    @csrf
    ...
    <div class="col-md-12">
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input class="form-control" value="{{ $userData->first_name ?? old('first_name') }}" id="first_name"
                    name="first_name" type="text" placeholder="Enter your first name">
            </div>
            <div class="col-sm-2">
                <input class="form-control" value="{{ $userData->middle_name ?? old('middle_name') }}" id="middle_name"
                    name="middle_name" type="text" placeholder="M">
            </div>
            <div class="col-sm-4">
                <input class="form-control" id="last_name" value="{{ $userData->last_name ?? old('last_name') }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10 form-group mb-3">
                <input class="form-control" id="email" name="email" value="{{ $userData->email ?? old('email') }}"
        ...
        <div class="form-group row" id="show_contact_group_dropdown">
            ...
            <div class="col-md-6 form-group mb-3">
                <select class="form-control contact_group" id="contact_group" name="contact_group"
                    ...
                    <option <?php if($UsersAdditionalInfo->contact_group_id==$val->id){ echo "selected=selected"; }?>
                        value="{{$val->id}}"> {{$val->group_name}}</option>
                    <?php } ?>
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10 form-group mb-3">
                <label class="switch pr-5 switch-success mr-3"><span>Enable</span>
                    <input type="checkbox"
                        <?php if($UsersAdditionalInfo->client_portal_enable=="1"){ echo "checked=checked"; }?>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4 form-group mb-3">
                <input class="form-control" id="home_phone" value="{{ $userData->home_phone ?? old('home_phone') }}"
                    name="home_phone" placeholder="Enter home phone">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-3 form-group mb-3">
                <input class="form-control" id="work_phone" value="{{ $userData->work_phone ?? old('work_phone') }}"
                    name="work_phone" placeholder="Enter work phone">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-3 form-group mb-3">
                <input class="form-control" id="mobile_number"
                    value="{{ $userData->mobile_number ?? old('mobile_number') }}" name="cell_phone"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10 form-group mb-3">
                <input class="form-control" id="address" name="address"
                    value="{{ $userData->street ?? old('address') }}" type="text" placeholder="Enter address">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-md-10 form-group mb-3">
                <input class="form-control" id="address2" name="address2"
                    value="{{ $UsersAdditionalInfo->address2 ?? old('address2') }}" type="text"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4 form-group mb-3">
                <input class="form-control" id="city" name="city" value="{{ $userData->city ?? old('city') }}"
                    placeholder="Enter city">
            </div>
            <div class="col-md-3 form-group mb-3">
                <input class="form-control" id="state" name="state" value="{{ $userData->state ?? old('state') }}"
                    placeholder="Enter state">
            </div>
            <div class="col-md-3 form-group mb-3">
                <input class="form-control" id="postal_code" value="{{ $userData->postal_code ?? old('postal_code') }}"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10 form-group mb-3">
                <select class="form-control country" id="country" name="country" data-placeholder="Select Country"
                    ...
                    <option <?php if($userData->country==$val->id){ echo "selected=selected"; }?> value="{{$val->id}}">
                        {{$val->name}}</option>
                    <?php } ?>
                </select>
            </div>
        ...
        <span id="addmorearea" class="collapse">
            ...
            <div class="form-group row">
                ...
                if($UsersAdditionalInfo->dob!=NULL){
                    ...
                    <input class="form-control datepicker" id="dob" readonly value="{{ ($DOB)??old('dob') }}" name="dob"
            ...
            <div class="form-group row" id="show_company_dropdown">
                ...
                <div class="col-md-6 form-group mb-3">
                    <select id="company_name" name="company_name[]" multiple class="form-control custom-select col"
                        style="width:100%">
                        <option value="">Select company</option>
                        <?php foreach($CompanyList as $companyKey=>$companyVal){?>
                        <option
                            <?php if(in_array($companyVal->id,explode(",",$UsersAdditionalInfo->multiple_compnay_id))){ echo "selected=selected"; }?>
                            value="{{$companyVal->id}}"> {{$companyVal->first_name}} {{$companyVal->last_name}}</option>
                        <?php } ?>
                    </select>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10 form-group mb-3">
                    <input class="form-control" id="job_title"
                        value="{{ $UsersAdditionalInfo->job_title ?? old('job_title') }}" name="job_title" type="text"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4 form-group mb-3">
                    <input class="form-control" id="driver_license" name="driver_license"
                        value="{{ $UsersAdditionalInfo->driver_license ?? old('driver_license') }}"
                        placeholder="Enter driver license">
                </div>
                <div class="col-md-3 form-group mb-3">
                    <input class="form-control" id="driver_state" name="driver_state"
                        value="{{ $UsersAdditionalInfo->license_state ?? old('driver_state') }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10 form-group mb-3">
                    <input class="form-control" id="website"
                        value="{{ $UsersAdditionalInfo->website ?? old('website') }}" name="website" type="text"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10 form-group mb-3">
                    <input class="form-control" id="fax_number"
                        value="{{ $UsersAdditionalInfo->fax_number ?? old('fax_number') }}" name="fax_number"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10 form-group mb-3">
                    <textarea name="notes" class="form-control" rows="5"
                        placeholder="Enter notes">{{ $UsersAdditionalInfo->notes ?? old('notes') }}</textarea>
                </div>
            </div>
        </span>
        <div class="">
                    ...
                    <div class="col">
                        <div>Have more information you want to add? You can create custom fields for
                            ...
                            and clicking "Custom Fields".<a class="ml-2"
                                href="https://help.mycase.com/s/article/Custom-Fields-Overview-w-VIDEO" target="_blank"
        ...
        <div class="form-group row">
            ...
            <label for="inputEmail3" class="col-sm-2 col-form-label"><button
                    class="btn btn-primary ladda-button example-button m-1 submit" id="submit" type="submit"
                    data-style="expand-left"><span class="ladda-label">Update Contact</span><span
