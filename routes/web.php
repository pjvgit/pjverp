...
Route::group(['middleware'=>['auth:web', 'user.role:user']], function () {
    ...
    Route::post('browserClose', 'HomeController@browserClose')->name('browserClose');    
    ...
    Route::middleware(['permission:event_add_edit|event_view'])->group(function () {
     Route::get('events/{view?}', 'CalendarController@index')->name('events/');
    ...
    Route::post('bills/invoices/getStaffandClientListOfInvoice', 'BillingController@getStaffandClientListOfInvoice')->name('bills/invoices/getStaffandClientListOfInvoice');
    ...
    Route::get('bills/invoices/save/temp/info', 'BillingController@saveInvoiceTempInfo')->name('bills/invoices/save/temp/info');
