...
--
-- Host: localhost:3306
-- Generation Time: Apr 30, 2021 at 08:23 AM
...
CREATE TABLE `all_history` (
  ...
  `action` enum('add','update','delete','none','pay','complete','incomplete','share','comment','archive','unarchive') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'none',
...
CREATE TABLE `potential_case_invoice` (
  ...
  `amount_paid` decimal(11,2) DEFAULT NULL COMMENT 'ref : lead_notes_activity->id',
...
CREATE TABLE `users` (
  ...
  `user_role` int NOT NULL COMMENT 'ref=user_role->id',
